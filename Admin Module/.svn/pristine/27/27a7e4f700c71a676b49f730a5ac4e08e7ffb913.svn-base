...
public class AddEditDateaSecurity {
    ...
    public void onClickSegment(ValueChangeEvent valueChangeEvent) {
        String Value = valueChangeEvent.getNewValue().toString();
        System.err.println("Value===" + Value);
        ViewObject flwVo =
            ADFUtils.findIterator("DataSecSegment_ROVO1Iterator").getViewObject();
        System.err.println("count===" + flwVo.getEstimatedRowCount());
        flwVo.setNamedWhereClauseParam("p_segment", Value);
        flwVo.executeQuery();
        if (flwVo.getEstimatedRowCount() == 1) {
            System.err.println("4");
            JSFUtils.addFacesErrorMessage("Already this segment is entered");
            soc5.setValue(null);
